...
public class ParserTests {
    ...
    @Test
    void checkStatements() throws Exception {
        ...
        TreeNode functionCall2 = statements.get(0);

        assertEquals(TokenType.NAME, ((FunctionCall)functionCall2).getName().getType());
        assertEquals("foo2", ((FunctionCall)functionCall2).getName().getContent());
    }
